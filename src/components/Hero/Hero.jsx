    ...
    <header className="app__hero">
      <div className="app__hero-container">
        ...
        <div className="app__hero-link-container">
          <a className="app__hero-link" href="https://www.dropbox.com/s/q37cp1d8gmauziy/CV-CapanoAndres-FullStackDeveloper.pdf?dl=0" target="_blank" rel="noopener noreferrer">
