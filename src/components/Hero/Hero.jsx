    ...
    <header id="hero" className="app__hero">
      <div className="app__hero-container">
        ...
        <div className="app__hero-link-container">
          ...
          {language === "en"
            ? <a href="https://www.dropbox.com/s/dv77w8btllu9l3j/Resume-AndresCapano-FullStackDeveloper.pdf?dl=0" target="_blank" rel="noopener noreferrer">
            <button>
              <span></span>
              <span></span>
              <span></span>
            ...
            : <a href="https://www.dropbox.com/s/vrqvoa499ws3u3v/CV-AndresCapano-FullStackDeveloper.pdf?dl=0" target="_blank" rel="noopener noreferrer">
            <button>
              <span></span>
              <span></span>
              <span></span>
